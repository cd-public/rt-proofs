...
VFILES:=edf/total_service.v\
  edf/edf_demand_analysis.v\
  edf/demand.v\
  edf/transformation/swap.v\
  edf/transformation/insert.v\
  edf/transformation/erase.v\
