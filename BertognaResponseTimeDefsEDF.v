    ...
    Proof.
      ...
      (* Simplify names *)
        ...
        destruct n.
        {
          ...
          unfold job_interference, t2.
          rewrite subh1; last by admit. (* true, otherwise there would be no interference *)
          rewrite -[R_k](addnK t1).
        ...
        assert (NK: n_k >= n.+1).
        {
          ...
          apply leq_trans with (p := job_arrival j_lst + d_k) in DIST; last by apply leq_addr.
